...
class FavoritePage(Page):
    def __init__(self, **kwargs):
        ...
        # 2. Jalankan loading favorit di background thread saat init
    ...
    def load_library_in_background(self):
        library = self.api.get_favorite_books()  # Ambil data favorit dari DB
    ...
    def on_mapped(self, widget, param_spec):
        if self.get_mapped():
            # Setiap kali tab Favorite dibuka, refresh data favorit otomatis
            self.reload_favorites()
